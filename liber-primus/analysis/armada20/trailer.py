...
def trail(p):
    ...
    i=d.rfind(b'\xff\xd9')
    return d, d[i+2:]
for p in [_REPO + "/liber-primus/data/relikd/0_wisdom.jpg",
          _REPO + "/puzzles/2014/images/liber_primus_pages/lp_page_05.jpg"]:
    d,t=trail(p)
    print(p)
...
_,t1=trail(_REPO + "/liber-primus/data/relikd/0_wisdom.jpg")
_,t2=trail(_REPO + "/puzzles/2014/images/liber_primus_pages/lp_page_05.jpg")
