...
texts=[("thoth_full","analysis/foundation/thoth_letters.txt"),
       ("thoth_body","analysis/foundation/thoth_body.txt")]
...
for lab,f in texts:
    ...
    print(f"[{lab}] best interrupter-beam score: {glob_best[0]:.3f}",flush=True)
...
json.dump([{"label":l,"score":b[0],"detail":b[1]} for l,b in best_overall],
          open("analysis/foundation/thoth_interrupt.json","w"),indent=2)
