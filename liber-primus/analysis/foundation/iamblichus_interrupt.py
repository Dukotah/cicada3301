...
texts=[("iamblichus_pythagoras","analysis/foundation/iamblichus_pythagoras_letters.txt"),
       ("toa_waterfield","analysis/foundation/toa_letters.txt")]
...
json.dump([{"label":l,"score":b[0],"detail":b[1]} for l,b in best_overall],
          open("analysis/foundation/iamblichus_interrupt.json","w"),indent=2)
