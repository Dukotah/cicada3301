...
texts=[("monas_clean","analysis/foundation/monas_clean_key.txt"),
       ("enoch","analysis/foundation/enoch_key.txt")]
results=[]
for lab,f in texts:
    key=load_key(f)
    glob_best=(-99,None)
    ...
    print("   ",glob_best[1])
    results.append({"label":lab,"score":glob_best[0],"detail":glob_best[1]})
json.dump(results,open("analysis/foundation/dee_interrupt.json","w"),indent=2)
