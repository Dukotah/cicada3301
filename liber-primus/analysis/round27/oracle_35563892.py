#!/usr/bin/env python3
"""Round 27 — ORACLE adjudication of the S1 claim-bar crosser, seed 35563892.

Protocol (MONITORING.md "If HIT-CANDIDATE.json appears"):
...
Run:  nice -n 15 python3 oracle_35563892.py
"""
import json
import os
import sys
...
SEED = 35563892
C_PMAX = 7.6707232992600876        # from run/HIT-CANDIDATE.json (C screen, lane S1)
