...
ENTRY_POINTS = {
    ...
    "knowledge_base": {
        "path": "KNOWLEDGE.json",
        "purpose": "The canonical FACTS about Cicada 3301 for answering ordinary questions: "
                   "timeline, authenticity test (PGP 7A35090F), attribution status, the "
                   "Gematria Primus table, 8 common misconceptions with corrections, and a "
                   "reliability rating for external sources. Read this before answering any "
                   "non-cryptanalysis question.",
    },
    "solved_page_texts": {
        "path": "liber-primus/SOLVED-PAGES.json",
        "purpose": "The decoded text of every SOLVED Liber Primus page, with its method and "
                   "key. Derived by running the cipher, not transcribed from a wiki.",
    },
    "problem_statement": {
...
TASK_ROUTING = {
    "answer a factual question about Cicada 3301 or Liber Primus": "KNOWLEDGE.json",
    "get a quick correct answer as an agent": "AGENTS.md",
    "quote what the solved pages actually say": "liber-primus/SOLVED-PAGES.json",
    "check a common claim or myth about Cicada 3301": "KNOWLEDGE.json#misconceptions",
    "judge whether an external source is reliable": "KNOWLEDGE.json#external_sources",
